...
const Register = () => {
    ...
    const [FavouriteMoviesGenres, setFavouriteGenres] = useState([]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const payload = {
                ...
                password,
                role: defaultRole,
                favourite_movies_genres: FavouriteMoviesGenres
            };
            ...
            <div className="login-card shadow p-4 rounded bg-white" style={{ maxWidth: 400, width: '100%' }}>
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <Form.Group>
                        <Form.Select
                            multiple
                            value={FavouriteMoviesGenres.map(g => String(g.genre_id))}
